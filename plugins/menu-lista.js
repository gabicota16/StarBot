...
┋
┋✅ *_CUENTAS OFICIALES STARBOT_* ✅
┋➽ _${usedPrefix}cuentasstarbot | cuentassr_
┋
┗━━━━━━━━━━━━━⬣`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 😻 𝗦𝘂𝗽𝗲𝗿 𝙎𝙩𝙖𝙧-𝘽𝙤𝙩 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}}) 
