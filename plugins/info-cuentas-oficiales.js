...
/*conn.sendHydrated(m.chat, str, wm, media, 'https://github.com/gabicota16/StarBot', '𝙎𝙩𝙖𝙧-𝘽𝙤𝙩', null, null, [
['𝙂𝙧𝙪𝙥𝙤𝙨 𝙊𝙛𝙞𝙘𝙞𝙖𝙡𝙚𝙨 | 𝙂𝙧𝙤𝙪𝙥𝙨 🔰', '.grupos'],
['𝘾𝙧𝙚𝙖𝙙𝙤𝙧𝙖 | 𝘾𝙧𝙚𝙖𝙩𝙤𝙧 💗', '#owner'],
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́ | 𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', '/menu']
], m,)}*/

handler.command = /^cuentasoficiales|starig|cuentassr|cuentasr|accounts|staraccounts|account|igstar|cuentasdestar|cuentasdestarbot|cuentastarbot|cuentasstarbot$/i
handler.exp = 35
