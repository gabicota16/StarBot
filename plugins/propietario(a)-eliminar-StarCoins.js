...
/*conn.sendHydrated(m.chat, `╭━━━[ 𝙎𝙏𝘼𝙍𝘾𝙊𝙄𝙉𝙎 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ *${text}*\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE ELIMINÓ | WAS REMOVED*\n┃ღ *${gatacoins} StarCoin(s)*\n┃\n╰━━━━━━━━━━━━━━⬣`, wm, null, md, '𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿', null, null, [
['💗 𝙈𝙚𝙣𝙪 𝘼𝙫𝙚𝙣𝙩𝙪𝙧𝙖 | 𝙍𝙋𝙂 💗', '.rpgmenu'],
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́ | 𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', '/menu']], m)
}*/
handler.help = ['addgb <@user>']
handler.tags = ['gatacoins']
handler.command = ['eliminarstarcoins', 'eliminarstar', 'eliminarcoins', 'quitarstarcoins', 'quitarstar', 'quitarcoins', 'delstarcoins', 'delstar', 'delcoins'] 
handler.group = true
handler.rowner = true
